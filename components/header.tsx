...
export function Header() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 w-full border-b border-border backdrop-blur-sm ${isScrolled ? "bg-primary shadow-md" : "bg-primary"} transition-all duration-300`}
    >
